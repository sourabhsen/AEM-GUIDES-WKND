...
export default {
  title: 'pageAuthoring/Content-fragment-list',
  tags: ['autodocs'],
  decorators: [],
  parameters: { 
    myAddonParameter: {
...
// Start of story
import Example_1_TemplatePath from '../../storybook-assets/components/pageAuthoring/content-fragment-list/Elements.html';
...
// Start of story
import Example_2_TemplatePath from '../../storybook-assets/components/pageAuthoring/content-fragment-list/Order-By-and-Sort-Order.html';

export const OrderbyandSortOrder = () => `${Example_2_TemplatePath}`

OrderbyandSortOrder.story = {
  name: 'Order by and Sort Order',
  parameters: {
    design: {
...
// Start of story
import Example_3_TemplatePath from '../../storybook-assets/components/pageAuthoring/content-fragment-list/Standard.html';
...
// Start of story
import Example_4_TemplatePath from '../../storybook-assets/components/pageAuthoring/content-fragment-list/Tags.html';

export const Tags = () => `${Example_4_TemplatePath}`
